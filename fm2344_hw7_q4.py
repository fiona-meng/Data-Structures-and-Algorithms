    ...
    def iterative_inorder(self):
        ...
        while curr is not None:
            if curr.left is None:
                ...
                previous_node = curr.left
                while previous_node.right is not None and previous_node.right is not curr:
                    previous_node = previous_node.right

                if previous_node.right is None:
                    previous_node.right = curr
                    curr = curr.left
...
#     print(item, end=' ')
# for item in tree1.iterative_inorder():
#     print(item, end=' ')
